...
PARAM_SPEC: list[tuple[str, int, float, float]] = [
    ...
    ("blend_alpha",         1,  0.0, 0.5),     # approach-phase blending a=(1-α)a_vla+α·a_toward; 0 = pure VLA (identity)
...
class S3Params:
    ...
    blend_alpha: float = 0.0                 # identity = no approach shaping: the raw VLA is the baseline
